...
save-to-disk/CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.o: save-to-disk/rs-save-to-disk.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/IntelRealSense_Files/librealsense/examples/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object save-to-disk/CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.o"
	cd /root/IntelRealSense_Files/librealsense/examples/save-to-disk && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.o -c /root/IntelRealSense_Files/librealsense/examples/save-to-disk/rs-save-to-disk.cpp
...
save-to-disk/CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.i: cmake_force
	...
	cd /root/IntelRealSense_Files/librealsense/examples/save-to-disk && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/IntelRealSense_Files/librealsense/examples/save-to-disk/rs-save-to-disk.cpp > CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.i
...
save-to-disk/CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.s: cmake_force
	...
	cd /root/IntelRealSense_Files/librealsense/examples/save-to-disk && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/IntelRealSense_Files/librealsense/examples/save-to-disk/rs-save-to-disk.cpp -o CMakeFiles/rs-save-to-disk.dir/rs-save-to-disk.cpp.s
...
save-to-disk/rs-save-to-disk: save-to-disk/CMakeFiles/rs-save-to-disk.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/IntelRealSense_Files/librealsense/examples/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable rs-save-to-disk"
	cd /root/IntelRealSense_Files/librealsense/examples/save-to-disk && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/rs-save-to-disk.dir/link.txt --verbose=$(VERBOSE)
...
save-to-disk/CMakeFiles/rs-save-to-disk.dir/clean:
	cd /root/IntelRealSense_Files/librealsense/examples/save-to-disk && $(CMAKE_COMMAND) -P CMakeFiles/rs-save-to-disk.dir/cmake_clean.cmake
.PHONY : save-to-disk/CMakeFiles/rs-save-to-disk.dir/clean

save-to-disk/CMakeFiles/rs-save-to-disk.dir/depend:
	cd /root/IntelRealSense_Files/librealsense/examples && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/IntelRealSense_Files/librealsense/examples /root/IntelRealSense_Files/librealsense/examples/save-to-disk /root/IntelRealSense_Files/librealsense/examples /root/IntelRealSense_Files/librealsense/examples/save-to-disk /root/IntelRealSense_Files/librealsense/examples/save-to-disk/CMakeFiles/rs-save-to-disk.dir/DependInfo.cmake --color=$(COLOR)
